...
#define TOTALCANOPYPARAMCOUNT 46
...
extern uint16_t       GenericGetAttributeMaxLen(uint16_t attributeNumber);                           
extern uint16_t       GetBucketIndex(uint16_t attributeNumber);                                      
extern uint16_t       GenericGetAttributeByName(char * attrname);                                    
extern uint32_t       GetSCode(char * str);                                                          
extern uint16_t       GetCanopyParamCount();                                                         
extern void           PrintCanopyParams();                                                           
extern uint16_t       GetCanopyAttrNumFromIndex(uint16_t index, uint8_t * error);                     
extern uint32_t       GetCanopyDefaultValIntFromIndex(uint16_t index, uint8_t * error);              
extern void           GetCanopyDefaultStringFromIndex(uint16_t index, char * p_result, uint8_t plen, uint8_t * error);   
extern uint32_t       GetCanopyMinValFromIndex(uint16_t index, uint8_t * error);                     
extern uint32_t       GetCanopyMaxValFromIndex(uint16_t index, uint8_t * error);                     
extern bool           IsCanopyAttributeVendorType(uint16_t index, uint8_t * error);                  
extern uint16_t       GetCanopyIndexFromAttrNum(uint16_t attributeNumber, uint8_t * error);          
extern uint32_t       GetCanopyDefaultValueIntFromAttr(uint16_t AttributeNumber, uint8_t* error);    
