...
//Display Timeout gblDispTout_attr
/********
typedef enum {
...
// Display Timeout Param gblDispTout_attr -- NOTUSED
typedef enum {
...
/************************************************
//Global Manual Barcode Entry  gblManBCEntry_attr
typedef enum {
...
//Global Manual Quantity Entry gblManQTYEntry_attr
typedef enum {
...
//Auto Display Brightness gblAutoDispBrt_attr
typedef enum {
...
//Keypad Backlight gblKeypadBacklight_attr
typedef enum {
...
//Display On Charge gbDispOnCharge_attr
typedef enum {
...
//Home Key Launch  gblHomeKey_attr
typedef enum {
...
//Quantity Manual Barcode Entry seqManBCEdit_attr
typedef enum {
...
//Quantity Manual Quantity seqManQTYEdit_attr
typedef enum {
...
extern int8_t CST_APISend_ATTR(uint16_t attr_num, BYTE *value, uint16_t length, uint16_t offset, uint8_t type, bool permanent);
extern int8_t CST_APIGet_Attr(uint16_t attr_num, uint16_t max_len, uint8_t *type, uint16_t *length, uint8_t *value, uint8_t *properties);
