; Listing generated by Microsoft (R) Optimizing Compiler Version 19.37.32822.0 
	...
	TITLE	C:\TouchGFXProjects\KraftHeinz_DS3600\TouchGFX\build\Debug\obj\FontCache.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__AB560ADA_cstring DB 01H
__4DE16DEC_FontCache@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_1MO@OIAFJPEP@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ ; `string'
...
??_C@_1IE@NPIIMJBA@?$AAt?$AAy?$AAp?$AAe?$AAd?$AAT?$AAe?$AAx?$AAt?$AAs?$AA?5?$AA?$CB?$AA?$DN?$AA?5?$AA0@ DB 't'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1MO@OIAFJPEP@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
CONST	SEGMENT
??_C@_1MO@OIAFJPEP@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ DB 'C'
	...
	DB	'g', 00H, 'f', 00H, 'x', 00H, '\', 00H, 'T', 00H, 'y', 00H, 'p'
	DB	00H, 'e', 00H, 'd', 00H, 'T', 00H, 'e', 00H, 'x', 00H, 't', 00H
...
; _this$ = ecx
; File C:\TouchGFXProjects\KraftHeinz_DS3600\TouchGFX\generated\fonts\include\fonts\CachedFont.hpp
; Line 60
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __121BE4F0_CachedFont@hpp
...
; _this$ = ecx
; File C:\TouchGFXProjects\KraftHeinz_DS3600\TouchGFX\generated\fonts\src\FontCache.cpp
; Line 372
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __4DE16DEC_FontCache@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 373
	mov	eax, DWORD PTR _this$[ebp]
...
; Line 231
	mov	eax, DWORD PTR _this$[ebp]
	movzx	ecx, WORD PTR [eax+206]
	mov	edx, DWORD PTR _this$[ebp]
	movzx	eax, WORD PTR [edx+204]
	cmp	ecx, eax
	jge	SHORT $LN3@copyGlyph
	mov	eax, DWORD PTR _this$[ebp]
	movzx	ecx, WORD PTR [eax+212]
...
$LN3@assertVali:
	mov	esi, esp
	push	177					; 000000b1H
	push	OFFSET ??_C@_1MO@OIAFJPEP@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
