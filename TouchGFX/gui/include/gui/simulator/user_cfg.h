...
extern void set_function_key(uint8_t key, uint8_t setting, const char * str, bool permanent);
...
extern void set_manual_barcode_entry(uint8_t setting, bool permanent);
extern uint8_t get_manual_barcode_entry(void);

extern void set_manual_quantity_entry(uint8_t setting, bool permanent);
...
extern void set_display_on_charge(uint8_t setting, bool permanent);
...
/* Special handling for simulator vars ---------------------------------------*/
extern bool virtual_cfg_menu_lock;
