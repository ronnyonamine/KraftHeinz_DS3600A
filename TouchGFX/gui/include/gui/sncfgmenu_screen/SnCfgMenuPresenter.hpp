#ifndef SNCFGMENUPRESENTER_HPP
#define SNCFGMENUPRESENTER_HPP
...
class SnCfgMenuPresenter : public touchgfx::Presenter, public ModelListener, public KeypadHandler
{
public:
    SnCfgMenuPresenter(SnCfgMenuView& v);
